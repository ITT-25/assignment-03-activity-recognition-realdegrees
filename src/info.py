...
class SessionInfoDisplay:
    def __init__(self, batch: pyglet.graphics.Batch, session: Optional["TrainingSession"] = None):
        ...
        self.stage_name_label = pyglet.text.Label(
            "Stage: N/A", font_size=20,
            x=Config.window_width // 2, y=self.info_area_height - 30,
            anchor_x="center", anchor_y="center",
            batch=self.batch, color=(24, 24, 24, 255)
        )
        
        self.progress_label = pyglet.text.Label(
            "Progress: N/A", font_size=14,
            x=Config.window_width // 2, y=self.info_area_height - 60,
            anchor_x="center", anchor_y="center",
            batch=self.batch, color=(24, 24, 24, 255)
        )
        
        self.next_set_label = pyglet.text.Label(
            "Next activities: N/A", font_size=14, 
            x=Config.window_width // 2, y=self.info_area_height - 90,
            anchor_x="center", anchor_y="center",
            batch=self.batch, color=(24, 24, 24, 255),
